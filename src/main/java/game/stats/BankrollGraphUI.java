...
public class BankrollGraphUI implements BankrollObserver {
	...
	public void createGraph(String chartName) {
		...
		try {
			ChartUtilities.saveChartAsPNG(new File("C:\\Users\\leila\\Desktop\\opentestbed-project\\opentestbed-master-1\\opentestbed-master\\data\\" + chartName + "-chart.png"), chart, 1000, 700);
		} catch (IOException e) {
			e.printStackTrace();
		}
